...
import { Zap, Package, Clock, Shield, Truck, Star } from 'lucide-react';
...
const SERVICES = [
  {
    ...
    desc: 'Vodka, whisky, tequila, rum, gin, wine — delivered to your door in 30 minutes. No minimum order, no fuss.',
  ...
  {
    icon: Zap,
    title: 'Priority Rush Delivery',
    desc: 'Need it even faster? Mark your order as Priority and our riders will make it happen.',
    features: ['Fastest available rider assigned', 'Real-time order tracking', 'Available on select areas'],
  },
  {
    icon: Star,
    ...
    <main className="services">
      ...
      <section className="services__hero">
        ...
        <Reveal className="container services__hero-content">
          ...
          <p className="services__sub">Premium alcohol and convenience products delivered fast across Canada.</p>
        </Reveal>
      </section>
      ...
      <section className="section services__area">
        <Reveal className="container services__area-inner">
          <div>
            ...
            <p>Bottle Route currently serves communities across Canada. Enter your postal code at checkout to confirm delivery availability in your area. We're expanding regularly — if we're not in your area yet, we're coming soon.</p>
          ...
          <div className="services__area-map">
            <div className="services__area-map-inner">
              <span>🍁</span>
              <p>Serving communities<br />across Canada</p>
            </div>
          </div>
        </Reveal>
      </section>
      ...
      <section className="section services__cta">
        <Reveal className="container" style={{ textAlign: 'center' }}>
          ...
          <p style={{ color: 'var(--br-gray)', marginBottom: '2rem' }}>Browse our full selection and get delivery in 30 minutes.</p>
